...
func bindingFields(km *Keymap) map[string]*key.Binding {
	return map[string]*key.Binding{
		...
		"next_chat":       &km.NextChat,
		"prev_chat":       &km.PrevChat,
		...
		"next_folder":     &km.NextFolder,
		"prev_folder":     &km.PrevFolder,
		"show_image":      &km.ShowImage,
		"mark_message":    &km.MarkMessage,
		"forward_message": &km.ForwardMessage,
		"react_message":   &km.ReactMessage,
		"jump_to_reply":   &km.JumpToReply,
		"mute_chat":       &km.MuteChat,
		"pin_chat":        &km.PinChat,
		"toggle_unread":   &km.ToggleUnread,
