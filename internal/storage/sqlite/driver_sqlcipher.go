...
// SQLCipher driver is reserved for Stage 3. Building with -tags sqlcipher must
...
// clear message ("undefined: sqlcipherDriverReservedForStage3"), rather than
// producing a binary that panics at first run.
//
// When the real driver lands, replace this file with:
//
//	import _ "github.com/mutecomm/go-sqlcipher/v4"
//	const driverName = "sqlite3"
const driverName = sqlcipherDriverReservedForStage3
