...
**Состояние (19.08.2026):** живой smoke базового пути (логин, чаты, чтение, отправка, live-обновления) пройден на тестовом аккаунте и вскрыл десяток дефектов, невидимых тестам — разбор в auto-memory `lazytg_release_status`. Мышь, выделение текста, перетаскиваемый разделитель, циклический переход по чатам — в `main`.
