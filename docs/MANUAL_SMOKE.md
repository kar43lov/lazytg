...
🔴 Миграции `0012` и `0013` накатятся на рабочую БД при первом запуске ветки. Бэкап до запуска: `cp ~/Library/Application\ Support/lazytg/lazytg.db ~/Library/Application\ Support/lazytg/lazytg.db.bak-before-0012`.
