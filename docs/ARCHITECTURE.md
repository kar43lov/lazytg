...
| `internal/storage/sqlite`        | 1–3   | Repository implementation: migrations 0001–0016, FTS5 trigram index, frecency, dedup tables, outgoing/peers/state repos.            | `internal/core/domain`                  | `internal/ui`, `internal/tg`             |
